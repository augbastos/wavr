...
Repo: `<repo>` · data: 2026-07-03 · foco: cobertura de testes, código morto, arquivos gigantes, drift docs/ADR vs código. Auditorias de segurança/perf anteriores já cobriram bastante — aqui olhei regressões e o que audits podem ter perdido.
